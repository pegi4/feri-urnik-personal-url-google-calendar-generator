export default function HowToUse() {
  return (
    <div class="p-8 font-sans mt-6 max-w-lg mx-auto">
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-300 mb-2">The Calendar URL Generator lets you:</p>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-300 mb-4">
          ...
          link:{" "}
          <span class="block rounded-md p-2 mt-2">
            https://www.wise-tt.com/wtt_um_feri/index.jsp?filterId=0;37;0;0
          </span>
          The{" "}
          <code class="text-sm bg-gray-300 text-rose-800 px-2 py-1 rounded">
            0;37;0;0
          </code>{" "}
      ...
      <section class="mb-8">
        <h2 class="text-2xl font-semibold text-gray-200 mb-4">Example URL:</h2>
        <span class="block bg-gray-200 text-rose-800 rounded-md p-2 text-sm">
      ...
      <section>
        ...
        <p class="text-gray-300">To integrate with Google Calendar:</p>
        <ul class="list-decimal list-inside text-gray-300 mb-4">
